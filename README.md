[README.md](https://github.com/user-attachments/files/30381701/README.md)
...
This repository contains the MATLAB source, deterministic seeds, final audit
outputs, canonical case files, and plotting scripts supporting the reported
results.
...
## Source hygiene and privacy

Local absolute paths, email addresses, development logs, tuning traces,
reference papers, and version-control metadata from the development workspace
are excluded. MATLAB comments are removed from every packaged `.m` file.
Character data containing percent signs, such as format strings and axis
labels, are retained because they are executable content rather than comments.
